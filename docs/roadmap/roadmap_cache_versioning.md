...
export const CACHE_VERSION = {
  // Versão do schema do AsyncStorage — bumpar ao mudar estrutura de dados
  SCHEMA: '2.0.0',
...
- **Não bumpar `SCHEMA_VERSION` sem uma migração correspondente na Fase 4.** Bumpar a versão sem migração apaga os dados do usuário silenciosamente.
