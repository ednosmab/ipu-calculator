...
Locator: getByRole('heading', { name: 'Modelos' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Modelos' })
      ...
      - generic [ref=e24]:
        - generic [ref=e25]:
          - generic [ref=e26] [cursor=pointer]:
            - generic [ref=e27]: KIKO
            - generic [ref=e28]: 
          - generic [ref=e30] [cursor=pointer]:
            - generic [ref=e31]: "Tempo:"
            - generic [ref=e32]: 68,00s
      ...
      - generic [ref=e80]:
        - generic [ref=e81]:
          ...
          - generic [ref=e86] [cursor=pointer]:
            - generic [ref=e87]: "Tempo:"
            - generic [ref=e88]: 15,71s
      ...
      - generic [ref=e94]:
        - generic [ref=e95]:
          ...
          - generic [ref=e100] [cursor=pointer]:
            ...
            - generic [ref=e102]: 15,71s
        - generic [ref=e104] [cursor=pointer]: 
        - generic [ref=e106] [cursor=pointer]: 
  - button "Criar Novo" [ref=e109] [cursor=pointer]:
    - generic [ref=e110]: 
    - generic [ref=e111]: Criar Novo
```
...
> 31  |   await expect(page.getByRole('heading', { name: 'Modelos' })).toBeVisible({ timeout: 10_000 });
      |                                                                ^ Error: expect(locator).toBeVisible() failed
  32  | }
  33  | 
